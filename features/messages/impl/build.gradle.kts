...
dependencies {
    ...
    implementation(projects.libraries.imageeditor)
    implementation(projects.libraries.imageeditorLast)
    implementation(projects.libraries.imageeditorModular)
    implementation(projects.libraries.imageeditorNative)
    implementation(projects.libraries.imageeditorPhotoeditor)
    implementation(projects.libraries.videoeditorNative)
