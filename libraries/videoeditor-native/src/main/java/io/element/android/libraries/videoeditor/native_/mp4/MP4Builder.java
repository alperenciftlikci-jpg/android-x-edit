...
public class MP4Builder {
    ...
    public void finishMovie(File into) throws Exception {
        ...
        // ADAPTATION (only difference from Telegram's verbatim source): replace
        // org.telegram.messenger.AndroidUtilities.copyFile with the equivalent
        // java.nio.file.Files.copy call — same semantics, no Telegram-internal deps.
        Files.copy(Paths.get(currentMp4Movie.getCacheFile().getAbsolutePath()),
                Paths.get(into.getAbsolutePath()),
